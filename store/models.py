...
class Category(models.Model):
    ...
    slug = models.SlugField(max_length=150, verbose_name='Url для категории', 
                            unique=True, db_index=True)
    order = models.IntegerField(verbose_name='Порядок меню', blank=True, 
                                null=True)
...
class Tag(models.Model):
    ...
    slug = models.SlugField(max_length=50, verbose_name='Url для тэга',
                            unique=True, db_index=True)
